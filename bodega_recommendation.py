...
def fetching_json(index):
    with open('/Users/yashwalia/Desktop/archive/styles.csv{}.json'.format(index)) as f:
...
#     app.run()
    ...
    # file = streamlit.file_uploader('Upload Files', type=(['jpeg', 'jpg']))
    ...
    #         # display image
    #         i = Image.open(file)
    #         streamlit.image(i, width=400, caption = 'Uploaded Image')
